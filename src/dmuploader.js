...
(function($) {
  ...
  var defaults = {
    ...
    countSpeed: function(id, speed) {},
    countFinalSpeed: function(id, finalSpeed) {}
  };
  ...
  DmUploader.prototype.processQueue = function()
  {
    ...
    var total, finalSpeed, uploadSpeed;
    ...
    $.ajax({
      ...
      xhr: function(){
        ...
        if(xhrobj.upload){
          xhrobj.upload.addEventListener('progress', function(event) {
            ...
            var positionInterval = position - prePosition;
            uploadSpeed = !prePosition ? 0 : positionInterval > 1048576 ? returnFloat(positionInterval/1024/(new Date() - timeInterval))+"Mb/s" : returnFloat(positionInterval/(new Date() - timeInterval))+"Kb/s";
            total = event.total || event.totalSize;
            console.log(event.lengthComputable);
            console.log(total);
            if(event.lengthComputable){
              percent = Math.ceil(position / total * 100);
              console.log(percent);
              widget.settings.countSpeed(widget.queuePos, uploadSpeed);
            }
      ...
      success: function (data, message, xhr){
        console.log("success");
        finalSpeed = returnFloat(total/Math.floor(new Date() - originalTime))+"Kb/s";
        widget.settings.countFinalSpeed(widget.queuePos, finalSpeed)
